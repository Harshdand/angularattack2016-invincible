...
export class SeedConfig {
  ...
  APP_ASSETS:InjectableDependency[] = [
    {src: `${this.CSS_SRC}/awesome-bootstrap-checkbox.css`, inject: true, vendor: false},
    {src: `${this.CSS_SRC}/main.css`, inject: true, vendor: false},
    {src: `${this.CSS_SRC}/home.css`, inject: true, vendor: false},
    {src: `${this.CSS_SRC}/tasks-page.css`, inject: true, vendor: false}
  ];
